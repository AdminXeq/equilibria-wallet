    ...
    <q-page>
        <div class="init-screen-page text-center">
            <div class="absolute-center">
                <img src="xeq_logo_with_padding.png" width="400" class="q-mb-md">
                <div class="startup-icons q-mt-xl q-mb-lg">
                    <div ref="backend">
                        <svg width="64" viewBox="0 0 17 16" version="1.1" xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink" class="si-glyph si-glyph-link-3">
                    ...
                    <div ref="settings">
                        <svg width="64" viewBox="0 0 17 17" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div ref="daemon">
                        <svg width="64" viewBox="0 0 16 17" version="1.1" xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink" class="si-glyph si-glyph-network-2">
                            <defs></defs>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g transform="translate(1.000000, 1.000000)" fill="#434343">
                                    <path
                    ...
                    <div ref="wallet">
                        <svg width="64" viewBox="0 0 17 16" version="1.1" xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink" class="si-glyph si-glyph-wallet">
